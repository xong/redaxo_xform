      ...
      <p class="rex-widget-field">
       ...
       <p class="rex-widget-icons rex-widget-1col">
        <span class="rex-widget-column rex-widget-column-first">
          <a href="#" class="rex-icon-file-open" onclick="openLinkMap(\'LINK_'.$i.'\', \'&clang=0&category_id=1\');return false;" title="Link ausw�hlen" tabindex="21"></a>
          <a href="#" class="rex-icon-file-delete" onclick="deleteREXLink('.$i.');return false;" title="Ausgew�hlten Link l�schen" tabindex="22"></a>
        </span>
      </p>
    </div>
    </div>
