...
class rex_xform_value_number extends rex_xform_value_abstract
{
	...
	{
		return "text -> Beispiel: number|label|Bezeichnung|defaultwert|[no_db]|classes|min|max|step";
	}
	...
	function getDefinitions()
	{
		return array(
						...
						'name' => 'number',
						'values' => array(
									array( 'type' => 'name',   'label' => 'Zahlenfeld' ),
