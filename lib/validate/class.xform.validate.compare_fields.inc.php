...
class rex_xform_validate_compare_fields extends rex_xform_validate_abstract 
{
	...
	{
		return "compare_fields -> prüft ob = | != | < | > | <= | >=, beispiel: validate|compare|label1|label2|type<=|warning_message ";
	}
