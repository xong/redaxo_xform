<?php
class rex_xform_value_hashvalue extends rex_xform_value_abstract
{
  ...
  {
    return 'Erzeug einen Hash-Wert eines anderen Formularfeldes, wenn dieses nicht leer ist. Nutzt php Funktion hash()
