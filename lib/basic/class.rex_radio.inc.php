  ...
  class rex_radio
  {
    ...
    */
    ...
    foreach($this->options as $option)
    {
      ...
      $return .= '<li class="xform-element">';
      $return .= '<label class="xform-radio" for="'.$oid.'">'.$option["name"].'</label>';
      $return .= '<input class="xform-radio" id="'.$oid.'" type="radio" name="'.$this->getAttribute("name").'" value="'.$option["value"].'"';
